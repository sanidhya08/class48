...
var gameState = PLAY;
var powerpallet;
var pacmanEat,pacmanDeath,pacmanChomp;
...
function preload(){
  ...
  pacmanEat=loadSound("Sounds/pacman_eatfruit.wav");
  pacmanDeath=loadSound("Sounds/pacman_death.wav");
  pacmanChomp=loadSound("Sounds/pacman_chomp.wav")
}
